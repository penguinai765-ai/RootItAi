...
export default function SubjectAnalyticsPage() {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center w-full overflow-x-hidden">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 w-full overflow-x-hidden">
            {/* Header */}
            <div className="sticky top-0 z-30 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white p-4 md:p-6 shadow-md w-full">
                <div className="max-w-7xl mx-auto flex items-center justify-between w-full">
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                        <Link href="/student/analytics" className="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-all flex-shrink-0">
                            <ArrowLeft className="w-6 h-6" />
                        </Link>
                        <div className="min-w-0 flex-1">
                            <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight truncate">{analytics.subjectName || subjectCode}</h1>
                            <p className="text-purple-100 mt-1 text-sm font-medium truncate">Subject Analytics & Insights</p>
                        </div>
                    </div>
                </div>
            </div>

            <div className="max-w-7xl mx-auto p-3 md:p-6 space-y-6 pb-20 md:pb-6 w-full overflow-x-hidden">
                {/* Summary Cards */}
                <div className="flex flex-col gap-4 mb-6 md:flex-row md:gap-6 items-stretch w-full">
                    <div className="flex-1 bg-gradient-to-br from-blue-100 via-blue-50 to-cyan-50 p-6 rounded-2xl border-2 border-blue-200 shadow-lg flex flex-col items-center text-center min-w-0">
                    ...
                    <div className="flex-1 flex flex-row gap-4 md:flex-col md:gap-4 min-w-0">
                        <div className="flex-1 bg-gradient-to-br from-green-100 via-green-50 to-emerald-50 p-6 rounded-2xl border-2 border-green-200 shadow-lg flex flex-col items-center text-center min-w-0">
                        ...
                        <div className="flex-1 bg-gradient-to-br from-purple-100 via-purple-50 to-violet-50 p-6 rounded-2xl border-2 border-purple-200 shadow-lg flex flex-col items-center text-center min-w-0">
                ...
                <div className="space-y-4 w-full overflow-x-hidden">
                    ...
                    {analytics.chapterPerformance.map((chapter: any, chapterIndex: number) => {
                        ...
                        return (
                            <div key={chapter.id} className="shadow-lg border-0 bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden transition-all duration-300 w-full">
                                <button
                                ...
                                >
                                    <div className="flex items-center gap-3 min-w-0 flex-1">
                                        <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-purple-100 to-pink-100 flex-shrink-0">
                                            <IconComponent className="w-6 h-6 text-purple-600" />
                                        </span>
                                        <div className="text-left min-w-0 flex-1">
                                            <h3 className="text-base md:text-lg font-bold text-gray-800 leading-tight truncate">{chapter.name}</h3>
                                            <p className="text-xs md:text-sm text-gray-600 truncate">{chapter.attempts} attempts</p>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    className={`transition-all duration-300 overflow-hidden w-full ${isExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'} bg-gradient-to-br from-white/90 to-purple-50`}
                                >
                                    <div className="px-4 md:px-8 pb-4 md:pb-8 w-full overflow-x-hidden">
                                        {/* Performance Insights */}
                                        <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-4 mb-4 border border-yellow-200 w-full">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="space-y-1 text-sm">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-green-700 min-w-0">Strongest: <strong className="truncate">{chapter.strongest}</strong></span>
                                                        </div>
                                                        <div className="flex items-center gap-2">
                                                            <AlertCircle className="w-4 h-4 text-red-600 flex-shrink-0" />
                                                            <span className="text-red-700 min-w-0">Needs Work: <strong className="truncate">{chapter.needsWork && chapter.needsWork.length > 0 ? chapter.needsWork.join(', ') : 'No subtopics need work!'}</strong></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="mb-4 w-full">
                                            ...
                                            <div className="space-y-3 w-full">
                                                {chapter.subtopics.map((subtopic: any) => (
                                                    <div key={subtopic.id} className={`${getPerformanceBgColor(subtopic.averageScore)} rounded-xl p-4 border-2 ${getPerformanceBorderColor(subtopic.averageScore)} flex flex-col md:flex-row md:items-center md:justify-between gap-2 w-full`}>
                                                        <div className="flex items-center gap-2 min-w-0 flex-1">
                                                            <ListChecks className="w-4 h-4 text-purple-400 flex-shrink-0" />
                                                            <div className="min-w-0 flex-1">
                                                                <h5 className="font-semibold text-gray-800 text-sm md:text-base truncate">{subtopic.name}</h5>
                                                        ...
                                                        {subtopic.trend && subtopic.trend.length > 0 && (
                                                            <div className="w-full md:w-1/2 mt-2 md:mt-0 overflow-hidden">
                ...
                {analytics.cognitiveSkillSummary && (
                    <div className="shadow-lg border-0 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 mb-6 w-full overflow-x-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                            <div className={`flex flex-col items-center rounded-xl p-4 border-2 w-full ${analytics.cognitiveSkillSummary.conceptual === 'Strong' ? 'bg-green-100 border-green-300' : analytics.cognitiveSkillSummary.conceptual === 'Moderate' ? 'bg-yellow-100 border-yellow-300' : 'bg-red-100 border-red-300'}`}>
                                ...
                                <span className="font-semibold text-gray-700 text-center">Conceptual Understanding</span>
                            ...
                            <div className={`flex flex-col items-center rounded-xl p-4 border-2 w-full ${analytics.cognitiveSkillSummary.reasoning === 'Logical' ? 'bg-blue-100 border-blue-300' : analytics.cognitiveSkillSummary.reasoning === 'Superficial' ? 'bg-yellow-100 border-yellow-300' : 'bg-orange-100 border-orange-300'}`}>
                                ...
                                <span className="font-semibold text-gray-700 text-center">Reasoning Skill</span>
                            ...
                            <div className={`flex flex-col items-center rounded-xl p-4 border-2 w-full ${analytics.cognitiveSkillSummary.confidence === 'High' ? 'bg-purple-100 border-purple-300' : analytics.cognitiveSkillSummary.confidence === 'Medium' ? 'bg-pink-100 border-pink-300' : 'bg-red-100 border-red-300'}`}>
                                ...
                                <span className="font-semibold text-gray-700 text-center">Confidence</span>
                ...
                {analytics.cognitiveInsights && analytics.cognitiveInsights.length > 0 && (
                    <div className="shadow-lg border-0 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 mb-6 w-full overflow-x-hidden">
                        <div className="flex items-center gap-2 mb-4">
                        ...
                        <div className="space-y-3 w-full">
                            {analytics.cognitiveInsights.map((insight: string, index: number) => (
                                <div key={index} className="bg-white rounded-xl p-4 border-l-4 border-blue-400 flex items-start gap-3 shadow-sm w-full">
                                    ...
                                    <p className="text-gray-700 leading-relaxed min-w-0 flex-1">{insight}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 w-full">
                    {analytics.strengths && analytics.strengths.length > 0 && (
                        <div className="shadow-lg border-0 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 flex flex-col gap-2 w-full overflow-x-hidden">
                            <div className="flex items-center gap-2 mb-2">
                            ...
                            {analytics.strengths.map((strength: string, index: number) => (
                                <div key={index} className="flex items-center gap-2 bg-white rounded-lg px-3 py-2 shadow-sm w-full">
                                    <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
                                    <span className="text-gray-700 font-semibold min-w-0 flex-1 truncate">{strength}</span>
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    {analytics.weaknesses && analytics.weaknesses.length > 0 && (
                        <div className="shadow-lg border-0 bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-6 flex flex-col gap-2 w-full overflow-x-hidden">
                            <div className="flex items-center gap-2 mb-2">
                            ...
                            {analytics.weaknesses.map((weakness: string, index: number) => (
                                <div key={index} className="flex items-center gap-2 bg-white rounded-lg px-3 py-2 shadow-sm w-full">
                                    <AlertCircle className="w-4 h-4 text-red-600 flex-shrink-0" />
                                    <span className="text-gray-700 font-semibold min-w-0 flex-1 truncate">{weakness}</span>
                                </div>
                            ))}
                        </div>
                    )}
